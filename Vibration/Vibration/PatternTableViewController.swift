...
class PatternTableViewController: UITableViewController {
    ...
    var PatternRef: DocumentReference!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        PatternRef = self.db.collection("Pattern").document("DpfW6iqZKwdeUF7V96lr")
    ...
    override func numberOfSections(in tableView: UITableView) -> Int {
        //return number of fields-1
        //PatternRef.getDocument().GETKEYS
        return 5
    }
